...
#[derive(Debug, Default, Clone, Serialize, Deserialize, SettingSchema)]
#[serde(default)]
...
pub struct CustomGcodeHooks {
    ...
    #[setting(
        tier = 3,
        description = "G-code injected before each layer change",
    ...
    #[setting(
        tier = 3,
        description = "G-code injected after each layer change",
        override_safety = "warn"
    )]
    ...
    #[setting(
        tier = 3,
        description = "G-code injected during tool changes",
        override_safety = "warn"
    )]
    ...
    #[setting(
        tier = 3,
        description = "G-code injected before every layer (alias)",
        override_safety = "warn"
    )]
    ...
    #[setting(
        tier = 3,
        description = "G-code injected on color change",
        override_safety = "warn"
    )]
    ...
    #[setting(
        tier = 3,
        description = "G-code injected when print is paused",
        override_safety = "warn"
    )]
